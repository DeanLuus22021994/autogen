...
Yes, this is on the [roadmap](https://github.com/microsoft/autogen/issues/4006).
...
We are still actively developing AutoGen 0.5. One exciting new feature is the emergence of new SDKs for .NET. The python SDKs are further ahead at this time but our goal is to achieve parity. We aim to add additional languages in future releases.
...
The re-architecture of the framework started with multiple Microsoft teams coming together
