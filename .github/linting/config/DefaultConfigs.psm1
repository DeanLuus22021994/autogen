...
.DESCRIPTION
    Contains functions that return configuration templates for different
...
function Get-MarkdownLintCliConfig {
    <#
    .SYNOPSIS
        Gets the default MarkdownLint CLI configuration.
    .DESCRIPTION
        Returns a PSCustomObject representing the default configuration for
        the MarkdownLint CLI tool.
    .OUTPUTS
        [PSCustomObject] Default configuration
    #>
    [CmdletBinding()]
